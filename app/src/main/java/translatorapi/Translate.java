...
public final class Translate extends MicrosoftTranslatorApi {
    ...
    public static String execute(String text, Language from, Language to) throws Exception {
        ...
        String params = "from=" + URLEncoder.encode(from.toString(), "UTF-8") + "&to=" + URLEncoder.encode(to.toString(), "UTF-8") + "&text=" + URLEncoder.encode(text, "UTF-8");
    ...
    public static String[] execute(String[] texts, Language from, Language to) throws Exception {
        ...
        String params = (apiKey != null ? "appId=" + URLEncoder.encode(apiKey, "UTF-8") : "") + "&from=" + URLEncoder.encode(from.toString(), "UTF-8") + "&to=" + URLEncoder.encode(to.toString(), "UTF-8") + "&texts=" + URLEncoder.encode(buildStringArrayParam(texts), "UTF-8");
